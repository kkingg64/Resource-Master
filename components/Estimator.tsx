        ...
        <table className="w-full text-left border-collapse table-fixed">
            ...
            <tbody className="text-[11px]">
                ...
                {modules.map((m, index) => {
                    ...
                    const prepBase = !isDev ? m.tasks.reduce((s, t) => s + (t.frontendFunctionPoints || 0), 0) : 0;
                    ...
                    const hasEffort = prepBase > 0 || moduleFeFp > 0 || moduleBeFp > 0;
                    ...
                    return (
                        ...
                        <tr draggable={!isReadOnly} onDragStart={(e) => handleDragStart(e, index)} onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, index)} className={`hover:bg-slate-50 transition-colors group ${draggedIndex === index ? 'opacity-40' : ''} ${typeStyle.rowBg}`}>
                            ...
                            <td className="p-0 border-b border-slate-100"><EstimatorNumberInput rowIndex={index * 1000} colIndex={0} onNavigate={handleNavigate} className={`${baseInputClass} font-bold disabled:bg-slate-50`} value={prepBase} onChange={() => {}} disabled={true} /></td>
                            <td className={nonEditableCell}>-</td><td className={nonEditableCell}>-</td><td className={nonEditableCell}>-</td>
