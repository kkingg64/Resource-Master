                ...
                {modules.map((m, index) => {
                    ...
                    return (
                        ...
                        <tr draggable={!isReadOnly} onDragStart={(e) => handleDragStart(e, index)} onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, index)} className={`hover:bg-slate-50 transition-colors group ${draggedIndex === index ? 'opacity-40' : ''} ${typeStyle.rowBg}`}>
                            ...
                            <td className="p-0 border-b border-slate-100 relative"><EstimatorNumberInput rowIndex={index * 1000} colIndex={3} onNavigate={handleNavigate} className={`${baseInputClass} font-bold text-slate-800 disabled:bg-slate-50`} value={moduleFeFp} onChange={() => {}} disabled={true} /></td>
                            {isDev ? <><td className={nonEditableCell}>-</td><td className={nonEditableCell}>-</td><td className={nonEditableCell}>-</td></> : <>
                            ...
                            <td className="p-0 border-b border-slate-100 relative"><EstimatorNumberInput rowIndex={index * 1000} colIndex={6} onNavigate={handleNavigate} className={`${baseInputClass} font-bold text-slate-800 disabled:bg-slate-50`} value={moduleBeFp} onChange={() => {}} disabled={true} /></td>
                            {isDev ? <><td className={nonEditableCell}>-</td><td className={nonEditableCell}>-</td><td className={nonEditableCell}>-</td></> : <>
