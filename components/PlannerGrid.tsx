...
export const PlannerGrid: React.FC<PlannerGridProps> = ({ 
  ...
  const handleAddTaskClick = (projectId: string, moduleId: string) => {
    ...
    if (name) {
      onAddTask(projectId, moduleId, name, Role.DEV);
    }
  };
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex bg-indigo-50/80 border-b border-slate-100 hover:bg-indigo-100/50 transition-colors group">
                        <div 
                          className="flex-shrink-0 p-3 pl-6 border-r border-slate-200 sticky left-0 bg-indigo-50/95 backdrop-blur-sm z-30 cursor-pointer flex items-center gap-2 shadow-[4px_0_10px_-4px_rgba(0,0,0,0.1)]"
                          style={stickyStyle}
